...
const style = {
  button: `mr-8 flex items-center py-2 px-12 rounded-lg cursor-pointer text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 focus:ring-purple-800`,
  buttonIcon: `text-xl`,
...
const MakeOffer = ({ selectedNft}) => {
  ...
  return ( <>
            {loading ? (
                  ...
                  <button className='text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-1 focus:outline-none focus:ring-purple-300 focus:ring-purple-800 font-medium rounded-lg text-sm px-3 py-1.5 text-center mr-2 mb-2 ' onClick={() => buyItem(selectedNft)}>Buy Element</button>
                )}
                <Toaster 
                  position="top-center"
                  reverseOrder={false}
